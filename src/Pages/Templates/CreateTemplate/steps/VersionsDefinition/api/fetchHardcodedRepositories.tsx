...
import { getContentList } from 'services/Content/ContentApi';
import { RepositoryOrigin, RepositoryListServerResponse } from '../../shared/types.server';
...
const LIMIT = 10;
const SORTBY = '';
const CONTENT_ORIGIN = [RepositoryOrigin.REDHAT];
