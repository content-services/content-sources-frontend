...
it('AdminFeaturesTable to render, select item, and copy', async () => {
  ...
  expect(navigator.clipboard.writeText).toHaveBeenCalledWith(
    '[{"name":"test_8","url":"http://test.com_8","red_hat_repo_structure":{"name":"test_8","content_label":"label_8","url":"http://test.com_8","arch":"arch_8","distribution_version":"version_8","feature_name":"test_8"}}]',
  );
});
