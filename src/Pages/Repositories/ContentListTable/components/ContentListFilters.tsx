          ...
          <FlexItem>
            <ToggleGroup aria-label='Default with single selectable'>
              <ToggleGroupItem
                ...
                onChange={() => {
                  const hasExternal = contentOrigin.includes(ContentOrigin.EXTERNAL);
                  const hasUpload = contentOrigin.includes(ContentOrigin.UPLOAD);

                  setContentOrigin((prev) => {
                    const custom = hasExternal && hasUpload;
                    return custom
                      ? prev.filter(
                          (origin) =>
