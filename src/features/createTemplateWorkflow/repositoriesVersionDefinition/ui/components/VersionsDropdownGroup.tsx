...
export const VersionsDropdownGroup = () => {
  ...
  const handleArchitecture = (_, val) => onSelectArchitecture(val as AllowedArchitecture);
  const handleOSVersion = (_, val) => onSelectOSVersion(val as AllowedOSVersion);
