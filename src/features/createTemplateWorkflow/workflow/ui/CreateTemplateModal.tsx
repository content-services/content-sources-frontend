...
import { VersionsStore } from 'features/createTemplateWorkflow/defineRepositoryVersion/store/VersionsStore';
...
import VersionDefinitions from 'features/createTemplateWorkflow/defineRepositoryVersion/ui/VersionsDefinitions';
import AdditionalRepositories from 'features/createTemplateWorkflow/additionalRepositories/ui/AdditionalRepositories';
import OtherRepositoriesSection from 'features/createTemplateWorkflow/otherRepositories/ui/OtherRepositories';
    ...
    >
      ...
      >
        ...
        <WizardStep
          ...
          footer={
            <WizardFooterWrapper>
              <CreateTemplateButton onCancel={cancelModal} />
            </WizardFooterWrapper>
          }
        >
