...
import OtherRepositoriesSection from './OtherRepositories';
import {
...
jest.mock(
  '@src/features/createTemplateWorkflow/otherRepositories/store/OtherRepositoriesStore',
  () => ({
...
it('expect Other Repositories to render correctly', () => {
  ...
  const { getByRole, getByText } = render(<OtherRepositoriesSection />);
