...
jest.mock(
  '@src/features/createTemplateWorkflow/reviewTemplateRequest/core/use-cases/formatTemplateReview',
  () => ({
...
it('expect Review step to render correctly', () => {
  ...
  (useFormatTemplateReview as jest.Mock).mockImplementation(() => templateReview);
