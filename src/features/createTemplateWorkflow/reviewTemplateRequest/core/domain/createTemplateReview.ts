import { TemplateRequestFinalized } from 'features/createTemplateWorkflow/shared/types.compound';
import { AllowedOSVersion } from 'features/createTemplateWorkflow/shared/types.simple';
import { TemplateReview } from '../types';

import { formatDateDDMMMYYYY } from './formatSnapshotDate';
