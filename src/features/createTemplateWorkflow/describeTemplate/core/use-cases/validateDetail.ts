...
import { ValidateTemplateDetail } from '../ports';
import { TemplateDetail } from 'features/createTemplateWorkflow/shared/types.simple';

type ValidateDetail = {
  isValidated: 'error' | 'default';
  validateDetail: ValidateTemplateDetail;
  error: string;
  text: TemplateDetail;
};
