...
--> TODO: picture of abstraction levels

--> TODO: picture of technology layers
...
> Go open [ContentListTable](). Without reading into the details, can you say which functionalities (like editTemplate, makeRepositorySnapshot) a user can trigger on that page?
...
--> TODO: pic horizontal vs vertical slices
