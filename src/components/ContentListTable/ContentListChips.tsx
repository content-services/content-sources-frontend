        ...
        <>
            <ChipGroup categoryName={'Version'}>
                {selectedVersions.map(version => (
                    <Chip key={version} onClick={() => deleteItem(version, selectedVersions, setSelectedVersions)}>
                        {version}
                    </Chip>
                ))}
            </ChipGroup>
            <ChipGroup categoryName={'Architecture'}>
                ...
                {(searchQuery !== '') && <ChipGroup categoryName={'Name/URL'}>
            ...
            && <Button onClick={clearFilters} variant="link" isInline>Clear filters</Button>}
        </>
    );
}
