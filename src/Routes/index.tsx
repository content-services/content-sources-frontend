...
import CreateTemplateModal from 'features/createAndEditTemplate/createTemplate/ui/CreateTemplateModal';
import EditTemplateModal from 'features/createAndEditTemplate/editTemplate/ui/EditTemplateModal';
    ...
    <ErrorPage>
      <Routes key={key}>
        ...
        <Route path={`${TEMPLATES_ROUTE}/:templateUUID`} element={<TemplateDetails />}>
          ...
          {rbac?.templateWrite && subscriptions?.red_hat_enterprise_linux ? (
            <Route path={`${EDIT_ROUTE}`} element={<EditTemplateModal />} />
          ) : null}
          {rbac?.templateWrite ? (
        ...
        <Route path={TEMPLATES_ROUTE} element={<TemplatesTable />}>
          {rbac?.templateWrite && subscriptions?.red_hat_enterprise_linux ? (
            <>
              ...
              <Route key='2' path={`:templateUUID/${EDIT_ROUTE}`} element={<EditTemplateModal />} />
              <Route
                key='3'
